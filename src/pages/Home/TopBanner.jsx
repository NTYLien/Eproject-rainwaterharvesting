      ...
      <div className="top-banner">
        ...
        <div className="content">
          ...
          <p className="banner-description">
            Rainwater harvesting has gained increasing attention in recent years
            as a sustainable water management practice. Education about the
            benefits of rainwater harvesting can encourage behaviour change.{" "}
          </p>
