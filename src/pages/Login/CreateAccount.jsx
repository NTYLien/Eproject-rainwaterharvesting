...
function CreateAccount(props) {
  ...
  useEffect(() => {
    fetch(
      `https://65d55b7e3f1ab8c63436c5ea.mockapi.io/userrainharvesting/${id}`,
      {
        method: "GET",
    ...
    <div className="create-account-page">
      <div className="container">
        ...
        <form action="#">
          ...
          <div className="terms">
            <div className="term">
              <input type="checkbox" name="terms" checked />I consent to
              Rainwater Harvesting collecting and managing my personal
              information in accordance with the Rainwater Harvesting Privacy
              Policy and Terms and Conditions.
            </div>

            <div className="term">
              <input type="checkbox" name="terms" />
              Send me the latest Rainwater Harvesting updates, with newsletters,
              catalogues and helpful tips.
            </div>
          </div>
          ...
          <div className="button">
            <button
              ...
              onClick={(e) => {
                ...
                fetch(
                  "https://65d55b7e3f1ab8c63436c5ea.mockapi.io/userrainharvesting",
                  {
                    method: "POST",
                    headers: { "content-type": "application/json" },
