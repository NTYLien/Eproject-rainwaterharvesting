    ...
    <div className="tool-page-form">
      <div class="form">
        <div class="header">
          ...
          <p>
            This tool will help to find out which product is perfect for your
        ...
        <form
          onSubmit={(e) => {
            ...
            const errors = ["storage", "location", "purpose", "filter"]
              .map((inputName) => {
          ...
          <div class="body">
            <div class="steps">
              <div class="step">
                ...
                <p>
                  The capacity of the storage tank will depend on how much roof
                  area you have, and how much rainfall you get! For domestic
                  system you will require about 1.000 litres of storage per
                  person
                </p>
                <div class="grid">
                  <div class="col">
              ...
              <div class="step">
                ...
                <p>
                  Rainwater harvesting storage is located above ground, below
              ...
              <div class="step">
                ...
                <p>
                  After filtering the water to remove smaller particulates,
                  sediment and onder contaminants. This water is now ready fo
                  household use.
                </p>
              ...
              <div class="step">
                <h4>
                  Will you filter be used for rain water, mains water or both?
                </h4>
                <p className="category-question">Filter question</p>
                <p>
                  If you use rainwater for appliances systems, we recommend
                  choosing both
                </p>
                <div class="grid">
                  <div class="col">
              ...
              <div class="step">
                <div class="confirmation">
                  <p>
                    For custom configurations and/or custom system drawings
                    please give us a call at{" "}
                    <span className="hotline">1068.6801.</span> Price can vary
      ...
      {clickSubmit &&
        productData
          .filter(
            (product) =>
              (product["storage-capacity"] === storage &&
            ...
            return (
              <div className="result-product">
                ...
                <button
                  ...
                  onClick={() => {
                    nav(`/products/${product.productCode}`);
                  }}
                >
                  Buy Now
                </button>
