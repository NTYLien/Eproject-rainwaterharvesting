                ...
                <form onSubmit={
                    (e) => {
                        ...
                        if (!userInfoFromTool.name || !userInfoFromTool.email || !userInfoFromTool.phone || !userInfoFromTool.country) {
                            toast.error("Sorry! Please fill-in required info question before submit the form");
                            return;
                        }
                        ...
                        const errors = ['info', 'method', 'system', 'material'].map(inputName => {
                        ...
                        <div class="steps">
                            <div class="step">
                                ...
                                <div class="grid">
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" id="email" name='info' required
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="number" id="phone" name='info' required
                                    ...
                                    <div class="col">
                                        ...
                                        <input type="text" id="address" name='info' required
                            ...
                            <div class="step">
                                ...
                                <div class="grid">
                                    <div class="col">
                                        <div class="checkbox">
                                            <input type="radio" name='method' value="rooftop-harvestion" id="rooftop-harvestion" />
                                    ...
                                    <div class="col">
                                        <div class="checkbox">
                                            <input type="radio" name='method' value="surface-runoff-harvesting" id="surface-runoff-harvesting" />
                            ...
                            <div class="step">
                                ...
                                <div class="grid">
                                    <div class="col">
                                        <div class="checkbox">
                                            <input type="radio" name='system' value="rain-barrel" id="rain-barrel" />
                                    ...
                                    <div class="col">
                                        <div class="checkbox">
                                            <input type="radio" name='system' value="dry-system" id="dry-system" />
                            ...
                            <div class="step">
                                ...
                                <div class="grid">
                                    <div class="col">
                                        <div class="checkbox">
                                            <input type="radio" name="material" value="polyethylene" id="polyethylene" />
                                    ...
                                    <div class="col">
                                        <div class="checkbox">
                                            <input type="radio" name="material" value="fiberglass" id="fiberglass" />
                                    ...
                                    <div class="col">
                                        <div class="checkbox">
                                            <input type="radio" name="material" value="steel" id='steel' />
                                    ...
                                    <div class="col">
                                        <div class="checkbox">
                                            <input type="radio" name="material" value="concrete" id='concrete' />
